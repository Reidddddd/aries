...
public class RestartDataNode extends RestartBase {
  ...
  public static final String DN_CHECK_STOPPED_COMMAND = "restart_datanode.check.stopped_command";
  ...
  public void init(Configuration configuration, Connection connection) throws IOException {
    ...
    check_stopped_command = configuration.get("cr." + DN_CHECK_STOPPED_COMMAND);
